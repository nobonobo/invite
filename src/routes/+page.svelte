	...
	async function submit(ev: any) {
		...
		if(hash!=ptn){
			...
			const modal: ModalSettings = {
				...
				// Data
				title: '電技OBの会にようこそ',
				body: 'あらかじめ、<a href="https://discord.com/register">Discord</a>のアカウントを作ってからアクセスしてください。<br/><a class="anchor" href="https://discord.gg/fPasnTVH">Discord invite URL</a><br/>2024/01/01 21:00~23:00 にビデオミーティングを開催予定です。参加お待ちしていますー。もちろんテキストのみの参加でも大歓迎！',
